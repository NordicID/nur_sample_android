...
public class DeviceSearchActivity extends AppCompatActivity implements BluetoothAdapter.LeScanCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSearchTimeout = MainActivity.DEVICE_SEARCH_TIMEOUT_MS;
    ...
    private void watchSearchInProgress()
    {
        ...
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                mControlBtn.setText(R.string.text_start_device_search);
            }
        });
    }
    ...
    private void beginSearch()
    {
        ...
        try {
            ...
            mScanning = false;
            MainActivity.shortToast(this, "Scan start error:\n" + ex.getMessage());
        }
        if (mScanning) {
    ...
    private void handleDeviceSelection(BLEDeviceDescription selectedDevice)
    {
        ...
        resultIntent.putExtra(MainActivity.BLE_SELECTED_ADDRESS, address);
        resultIntent.putExtra(MainActivity.BLE_SELECTED_NAME, name);
